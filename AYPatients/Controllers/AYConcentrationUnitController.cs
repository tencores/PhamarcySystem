/*
 * this is the concentration controller for concentration
 */
using System;
...
{
    public class AYConcentrationUnitController : Controller
    {
        ...
        public async Task<IActionResult> Index() //show the index
        {
            return View(await _context.ConcentrationUnit.ToListAsync());
        }

        // GET: ConcentrationUnit/Details/5
        public async Task<IActionResult> Details(string id) //show the details
        {
            if (id == null)
            {
                return NotFound();
        ...
        // GET: ConcentrationUnit/Create
        public IActionResult Create() //create a new concentration unit
        {
            return View();
        }

        // POST: ConcentrationUnit/Create
        ...
        // GET: ConcentrationUnit/Edit/5
        public async Task<IActionResult> Edit(string id) //edit one of the current concentration unit
        {
            if (id == null)
            {
                return NotFound();
        ...
        // GET: ConcentrationUnit/Delete/5
        public async Task<IActionResult> Delete(string id) //delete 1 record
        {
            if (id == null)
            {
                return NotFound();
        ...
        // POST: ConcentrationUnit/Delete/5
